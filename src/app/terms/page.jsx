        ...
        >
          ...
          <section>
            ...
            <div className="prose prose-invert max-w-none space-y-4 text-gray-300 leading-relaxed">
              <p>
                Welcome to{" "}
                <strong className="text-white">Shams Global Systems</strong>{" "}
                ("Company", "we", "us", or "our"). These Terms and Conditions
                ("Terms") govern your access to and use of our AI-powered
                trading solutions, Expert Advisors, and related services
                provided through our platform.
              </p>
              <p>
                By accessing our services, purchasing our products, or using our
                trading automation tools, you agree to be bound by these Terms.
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>Shams Global Systems provides the following services:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  AI-powered Forex trading Expert Advisors (EAs) for MetaTrader
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                <strong className="text-white">Subscription Fees:</strong> Our
                AI Trading Subscription is available at an annual subscription
                fee that grants you access to our licensed trading solutions.
                Pricing is subject to change and will be displayed at the time
                of purchase.
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-5 space-y-3">
                ...
                <p>
                  In addition to subscription fees, we offer consultation
                  services. Consultation pricing is subject to change and will
                  be displayed at the time of booking. Consultation services
                  include:
                </p>
              ...
              <p>
                ...
                accept payments via Razorpay (for INR transactions) and Stripe
                (for USD and international payments). All payments are processed
                securely, and your card details are never stored on our servers.
              </p>

              <p>
                <strong className="text-white">Refund Policy:</strong> All
                subscriptions and consultation fees are non-refundable once
                payment is processed. We recommend reviewing our service details
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-5">
                ...
                <ul className="space-y-2">
                  <li>
                    <strong className="text-white">Minimum:</strong> A deposit
                    of at least{" "}
                    <span className="font-bold text-yellow-200">
                      $10,000 USD
                    </span>{" "}
                    is required to safely operate our AI trading systems.
                  </li>
                  <li>
                    <strong className="text-white">Recommended:</strong> For
                    optimal performance, we recommend an account size of{" "}
                    <span className="font-bold text-yellow-200">
                      $100,000 USD
                    </span>{" "}
                    or higher.
              ...
              <p>
                These requirements ensure adequate capital for risk management
                and allow the trading algorithms to function as designed.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  Use our trading tools in compliance with applicable laws and
                  regulations
                </li>
                <li>
                  Maintain the confidentiality of your license keys and account
                  credentials
                </li>
                <li>
                  Not share, resell, or redistribute our Expert Advisors or
                  license keys
                </li>
                <li>
                  Use only licensed copies of MetaTrader 4 or MetaTrader 5
                  platforms
                </li>
                <li>
                ...
                <li>
                  Understand that trading involves financial risk and that past
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed bg-red-500/10 border border-red-500/30 rounded-lg p-5">
              <p>
                <strong className="text-red-300">IMPORTANT:</strong> Trading in
                foreign exchange (Forex) and other financial instruments carries
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  Our AI trading systems do not guarantee profits or eliminate
                  risk
                </li>
                <li>
                  Market conditions can change rapidly, affecting trading
                  performance
                </li>
                <li>
              ...
              <p>
                By using our services, you acknowledge that you understand these
                risks and that Shams Global Systems is not responsible for any
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                All content, algorithms, code, documentation, and materials
                provided by Shams Global Systems are protected by intellectual
                property laws. Our Expert Advisors, trading algorithms, and
                software are proprietary property of Shams Global Systems.
              </p>
              <p>
                You are granted a non-exclusive, non-transferable license to use
                our products for your personal trading purposes only. You may
                not:
              </p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                To the maximum extent permitted by law, Shams Global Systems
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                ...
                Terms or engage in any fraudulent, illegal, or harmful activity.
              </p>
              <p>
                You may cancel your subscription at any time; however, no
                refunds will be provided for unused portions of your
                subscription period.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                ...
                with the laws of the United Arab Emirates (UAE), without regard
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-5">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <strong className="text-white">Address:</strong> Dubai, United
                  Arab Emirates
                </li>
              </ul>
            </div>
