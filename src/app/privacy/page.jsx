        ...
        >
          ...
          <section>
            ...
            <div className="prose prose-invert max-w-none space-y-4 text-gray-300 leading-relaxed">
              ...
              <p>
                By accessing our website or using our services, you consent to
                the data practices described in this Privacy Policy. If you do
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  ...
                  Messages, inquiries, and support tickets you send to us
                </li>
              </ul>
              ...
              <p>
                When you use our Expert Advisors or trading services, we may
                collect anonymized trading data for analytical and improvement
                purposes. This data does not include personally identifiable
                information.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  To analyze usage patterns and improve our products and
                  services
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li>
                  Payment processors (Razorpay, Stripe) for processing
                  transactions
                </li>
              ...
              <p>
                ...
                response to valid legal requests, such as court orders,
                subpoenas, or government investigations.
              </p>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                ...
                however, disabling cookies may limit some functionality of our
                website.
              </p>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <p>
                ...
                information to our facilities in the United Arab Emirates and to
                the third-party service providers we use globally.
              </p>
            </div>
          </section>
